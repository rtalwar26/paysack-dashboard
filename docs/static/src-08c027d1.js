...
$_mod.def("/marko$4.13.13/dist/components/boot", function(require, exports, module, __filename, __dirname) { if (window.$initComponents) window.$initComponents();
});
$_mod.run("/marko$4.13.13/dist/components/boot");